...
from dataloader import InfDataloader, SODLoader, InfDataloader2


def parse_arguments():
    parser = argparse.ArgumentParser(description='Parameters to train your model.')
    parser.add_argument('--video_path', default='./videos/video.mp4', help='Path to video', type=str)
...
def run_inference(args):
    ...
    inf_data = InfDataloader2(video_path=args.video_path, target_size=args.img_size)
